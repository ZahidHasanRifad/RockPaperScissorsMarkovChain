...
public class Game {
	...
	public int[] result = new int[] { 0, 0, 0 }; 
	...
	public State nextMove(State prev) {
		...
		//System.out.println("size "+losesTo.size());
		
		return losesTo.get(0);
	}
	...
	public void play() {
		...
		System.out.println(
				"USER Win: " + result[0] + " - " + DECIMAL_FORMATTER.format(result[0] / (float) total * 100f) + "%");
		System.out.println(
				"Tie : " + result[2] + " - " + DECIMAL_FORMATTER.format(result[2] / (float) total * 100f) + "%");
